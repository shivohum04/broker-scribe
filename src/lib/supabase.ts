...
export const propertyService = {
  async getProperties(): Promise<Property[]> {
    ...
    return data.map(prop => ({
      ...
      rate: prop.rate || 0,
      rateType: prop.rate_type as 'total' | 'per_sqft' | 'per_acre',
      size: prop.size || 0,
      sizeUnit: prop.size_unit as 'sqft' | 'acres' | 'sqm',
  ...
  async addProperty(property: Omit<Property, 'id' | 'created_at' | 'updated_at'>): Promise<Property> {
    ...
    return {
      ...
      rate: data.rate || 0,
      rateType: data.rate_type as 'total' | 'per_sqft' | 'per_acre',
      size: data.size || 0,
      sizeUnit: data.size_unit as 'sqft' | 'acres' | 'sqm',
